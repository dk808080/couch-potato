    ...
    return(
        <div id="zip">
            ...
            <Container id="inner_zip">
                ...
                <label for="business" id="Business">Business</label>
               <div className="buttonIN">
                <input  className="zip_check" type="tel" placeholder="Enter Zip Code " pattern="[0-9]*" maxLength="6" />
